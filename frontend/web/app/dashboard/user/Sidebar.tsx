    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-card border-r">
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          <Link href="/dashboard/user" className="flex items-center px-3 py-2 rounded-lg hover:bg-muted transition">
            <Home className="h-4 w-4 mr-2" />
            User Dashboard
          </Link>
          <Link href="/dashboard/user/bookings" className="flex items-center px-3 py-2 rounded-lg hover:bg-muted transition">
